            ...
            <div className="container mx-auto px-4 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-4 max-w-xl">
                            Explore our carefully crafted developments that
                            blend luxury with sustainability, creating homes
                ...
                <div className="mt-16 text-center bg-muted rounded-2xl p-12">
                    ...
                    <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
                        Our team can help you find the perfect property that
                        matches your lifestyle and investment goals.
                    </p>
                    <Button variant="hero" size="lg" asChild>
                        <a
                            href="https://wa.me/919747770369?text=Hello%20KCN%20Builders%2C%20I%20would%20like%20to%20schedule%20a%20consultation."
                            target="_blank"
