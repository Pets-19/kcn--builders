                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                        <div>
                            ...
                            <p className="text-primary-foreground/70">
                                ...
                                sustainability initiatives, and exclusive
                                offers.
                            </p>
                        </div>
                        <form
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-primary-foreground/70 mb-6 leading-relaxed">
                            Building tomorrow's sustainable havens. We create
                            innovative living spaces that harmonize with nature
                        ...
                        <div className="card">
                            <a
                                ...
                                href="https://www.instagram.com/kcnbuilders/"
                                target="_blank"
                            ...
                            <a
                                ...
                                href="https://www.youtube.com/@kcnbuilders"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="YouTube"
                            >
                                <svg
                                    viewBox="0 0 16 16"
                                    className="socialSvg youtubeSvg"
                                >
                            ...
                            <a
                                ...
                                href="https://www.facebook.com/kcnbuilders/"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Facebook"
                            >
                    ...
                    <div>
                        ...
                        {/* Certifications */}
                        <div className="mt-8">
                            <h4 className="text-sm font-semibold mb-4 text-primary-foreground/60">
                                Certifications
                            </h4>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li>
                                ...
                                >
                                    ...
                                    <span>
                                        Mathilancheri Rd, Civil Station, Kairali
                                        Nagar, Kalpetta, Kerala 673122
                                    </span>
                                </a>
                            </li>
                            <li>
                        ...
                        <div className="mt-8">
                            <Button variant="ocean" className="w-full" asChild>
                                <a
                                    href="https://wa.me/919747770369?text=Hello%20KCN%20Builders%2C%20I'd%20like%20to%20get%20in%20touch%20with%20your%20team."
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    Get in Touch
