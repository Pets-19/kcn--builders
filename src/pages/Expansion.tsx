...
const Expansion = () => {
    const currentMarkets = [
        {
            ...
            icon: "🏔️",
            description:
                "Our roots in Kerala's pristine hills. The birthplace of KCN's vision for sustainable luxury living.",
        },
        {
            city: "Bangalore",
            ...
            icon: "🌆",
            description:
                "Expanding into India's tech capital with sustainable urban developments near major IT hubs.",
        },
        {
            city: "Kochi",
            region: "Kerala, India",
            ...
            icon: "🌊",
            description:
                "Premium coastal developments combining modern luxury with Kerala's rich maritime heritage.",
        },
    ];
    ...
    const upcomingMarkets = [
        {
            ...
            icon: "🏛️",
            description:
                "Planned developments respecting Mysore's rich cultural heritage while introducing green building practices.",
        },
        {
            city: "Dubai",
            region: "UAE",
            ...
            icon: "🏙️",
            description:
                "Strategic partnerships for climate-adaptive luxury villas in Dubai's premium districts.",
        },
        {
            city: "Abu Dhabi",
            region: "UAE",
            ...
            icon: "🌟",
            description:
                "Market research for sustainable developments aligned with UAE Vision 2030.",
        },
    ];
    ...
    const timeline = [
        {
            year: "2009-2015",
            milestone: "Wayanad Establishment",
            description:
                "Founded in Wayanad with focus on sustainable luxury villas",
        },
        {
            year: "2016-2020",
            milestone: "Kerala Expansion",
            description:
                "Expanded across Kerala with townships and integrated communities",
        },
        {
            year: "2021-2023",
            milestone: "Tech Integration",
            description: "Pioneered smart homes and green certifications",
        },
        {
            year: "2024",
            milestone: "Pan-India Growth",
            description:
                "Entered Bangalore and Kochi markets with urban projects",
        },
        {
            year: "2025-2026",
            milestone: "South India Consolidation",
            description: "Mysore, Calicut, and more Karnataka cities",
        },
        {
            year: "2027+",
            milestone: "International Expansion",
            description:
                "Middle East entry with Dubai and Abu Dhabi partnerships",
        },
    ];
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-muted-foreground leading-relaxed">
                            Our strategic expansion plan focuses on bringing
                            sustainable luxury living to major urban centers
                            across India and select international markets, while
                            maintaining our commitment to green building and
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Established presence with active developments and
                            delivered projects
                        </p>
                    </div>
            ...
            <section className="py-24 bg-muted">
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Strategic expansion into new territories with
            ...
            <section className="py-24 bg-background">
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            From humble beginnings in Wayanad to a pan-India and
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="relative">
                            ...
                            {timeline.map((item, index) => (
                                <div
                                    key={index}
                                    className="relative flex items-start mb-12 md:items-center"
                                >
                                    <div
            ...
            <section className="py-24 bg-primary text-primary-foreground">
                <div className="container mx-auto px-4 lg:px-8 text-center">
                    ...
                    <p className="text-primary-foreground/80 text-lg max-w-2xl mx-auto mb-8">
                        ...
                        Let's discuss opportunities for sustainable development
                        together.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button variant="hero-outline" size="lg" asChild>
                            <a
                                href="https://wa.me/919747770369?text=Hello%20KCN%20Builders%2C%20I'm%20interested%20in%20discussing%20partnership%20opportunities."
                                target="_blank"
